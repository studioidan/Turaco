 ...
 */
public class PanelStateFragment extends BaseFragment implements View.OnClickListener {
    ...
    public static PanelStateFragment newInstance(Context mComingcontext) {
        PanelStateFragment mFragment = new PanelStateFragment();
    ...
    private void loadPanelStatus() {
        //http://69.64.63.136:8080/api/PanelsStatus/8
