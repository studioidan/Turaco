 ...
 */
public class SetupMainFragment extends BaseFragment implements View.OnClickListener {

    ImageButton CamerEdit, PanelEdit;

    public static SetupMainFragment newInstance() {
        return new SetupMainFragment();
    }
